...
import { lpValue } from "@/lib/wolfpit/engine";
  ...
  return (
    <Shell>
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="mt-6 flex items-center justify-between rounded-[var(--radius-lg)] border border-border bg-surface p-4">
          <div>
          ...
          <Button variant="outline" onClick={harvest}>
            Harvest
          </Button>
        </div>
